...
export const ArchitectureDeepDive: React.FC = () => {
  return (
    <section id="architecture" className="py-20 bg-[#0d0f12] relative border-y border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-16">
          {/* Layer 1: Observers */}
          <div className="rounded-2xl border border-white/[0.08] bg-[#07080a] p-5 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 text-white/50 font-mono text-[11px] mb-3">
                <span>LAYER 01</span>
                <span>•</span>
                <span>OBSERVERS</span>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Passive Watchers</h3>
              <p className="text-[12px] text-[#a0a5ad] leading-relaxed mb-4">
                Listens to system signals without modifying agent processes or repository code.
              </p>
            </div>
            <ul className="space-y-2 font-mono text-[11px] text-[#c4c9d0] border-t border-white/[0.06] pt-3">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-[#07080a] p-5 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Canonical Event Bus</h3>
              <p className="text-[12px] text-[#a0a5ad] leading-relaxed mb-4">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-[#07080a] p-5 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Rule Engine</h3>
              <p className="text-[12px] text-[#a0a5ad] leading-relaxed mb-4">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-[#07080a] p-5 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Embedded SQLite</h3>
              <p className="text-[12px] text-[#a0a5ad] leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl border border-white/[0.08] bg-[#14171c] glow-card">
            <ShieldCheck className="size-6 text-white mb-3" />
            <h4 className="text-base font-semibold text-white mb-2">Zero AI API Token Costs</h4>
            <p className="text-[13px] text-[#a0a5ad] leading-relaxed">
          ...
          <div className="p-6 rounded-2xl border border-white/[0.08] bg-[#14171c] glow-card">
            <Monitor className="size-6 text-white mb-3" />
            <h4 className="text-base font-semibold text-white mb-2">Desktop Native Productivity</h4>
            <p className="text-[13px] text-[#a0a5ad] leading-relaxed">
          ...
          <div className="p-6 rounded-2xl border border-white/[0.08] bg-[#14171c] glow-card">
            <HardDrive className="size-6 text-white mb-3" />
            <h4 className="text-base font-semibold text-white mb-2">Zero Cloud Vendor Lock-In</h4>
            <p className="text-[13px] text-[#a0a5ad] leading-relaxed">
