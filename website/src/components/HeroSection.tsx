...
import { Menu, X, Download, Terminal, CheckCircle2, Copy } from 'lucide-react'
import confetti from 'canvas-confetti'

export function HeroSection({ onOpenCommandPalette }: { onOpenCommandPalette?: () => void }) {
  ...
  return (
    <>
      <HeroHeader onOpenCommandPalette={onOpenCommandPalette} />
      <main className="overflow-x-hidden">
        <section className="relative">
          <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
              <div className="mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-medium tracking-tight text-foreground md:text-6xl lg:mt-16 xl:text-7xl">
                  Control AI Coding Agents Locally
                </h1>
                <p className="mt-8 max-w-2xl text-pretty text-lg text-muted-foreground">
                  ...
                  Zero cloud servers, 0ms SQLite latency, and deterministic Kanban orchestration without spending API tokens.
                </p>
                ...
                <div className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
                  <Button
                    asChild
                    size="lg"
                    className="px-6 text-base font-semibold cursor-pointer shadow-lg hover:shadow-xl"
                  >
                  ...
                  <Button
                    ...
                    className="px-5 text-base font-mono cursor-pointer border border-border/60 hover:bg-accent flex items-center gap-2"
                  >
              ...
              {/* Abstract 3D Hero Visual Element from design.md */}
              <img
        ...
        {/* Infinite Logo Slider from design.md */}
            ...
            <div className="flex flex-col items-center md:flex-row">
              <div className="md:max-w-44 md:border-r border-border md:pr-6 mb-4 md:mb-0">
                <p className="text-center md:text-end text-sm text-muted-foreground font-medium">
                  Compatible with top AI harnesses
                </p>
              </div>
              <div className="relative py-6 md:w-[calc(100%-11rem)]">
                <InfiniteSlider speedOnHover={20} speed={40} gap={96}>
                  <div className="flex items-center gap-2 text-foreground font-mono text-sm font-semibold opacity-70 hover:opacity-100 transition-opacity">
...
const menuItems = [
  ...
  { name: 'MCP Protocol', href: '#mcp-playground' },
  { name: 'Architecture', href: '#architecture' },
  { name: 'Token ROI', href: '#roi' },
  { name: 'Comparison', href: '#comparison' },
  { name: 'Download', href: '#download' },
]

const HeroHeader = ({ onOpenCommandPalette }: { onOpenCommandPalette?: () => void }) => {
  ...
  return (
    <header>
      <nav
        ...
        className="group bg-background/50 fixed z-30 w-full border-b border-border/60 backdrop-blur-3xl top-0 left-0"
      >
        <div className="mx-auto max-w-6xl px-6 transition-all duration-300">
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
              <a href="#" aria-label="home" className="flex items-center space-x-2.5">
                <Logo />
